...
export class FormBaseComponent implements OnInit{
  ...
  ngOnInit() {
    this.cadastroForm = this.formBuilder.group({
      ...
      email: ['bts@email.com', [Validators.required, Validators.email]],
      senha: ['123', [Validators.required, Validators.minLength(3)]],
      genero: ['outro'],
      telefone: ['12123456789', Validators.required],
      estado: this.estadoControl,
      confirmarEmail: ['bts@email.com', [Validators.required, Validators.email, FormValidations.equalTo('email')]],
